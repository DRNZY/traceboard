...
- Name: run-inspector.spec.ts >> run index and inspector >> shows an event detail with redacted attributes and a run level marker
- Location: e2e/run-inspector.spec.ts:49:3
